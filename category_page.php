...
<meta charset="UTF-8">
    ...
    <link href="style/categorypagecss.css" rel="stylesheet">
...
include('db/config.php');
$name=$_GET['name'];
$query1=mysqli_query($con,"SELECT * FROM news_tbl WHERE category='$name' order by id desc ");
...
<?php }?>
        ...
        <div class="row">
            ...
            <a href="#" ><i class="fa fa-facebook-official" style="font-size:35px;padding:5px;color:#3b5998"></i></a>
            <a href="#"><i class="fa fa-twitter " style="font-size:35px;padding:5px;color:#00aced"></i></a>
            <a href="#"><i class="fa fa-whatsapp " style="font-size:35px;padding:5px;color:#25d366"></i></a>
            <a href="#"><i class="fa fa-reddit" style="font-size:35px;padding:5px;color:red"></i></a>
            <a href="#"><i class="fa fa-linkedin" style="font-size:35px;padding:5px;color:#023e8a"></i></a>
          <a href="#"><i class="fa fa-envelope " style="font-size:35px;padding:5px;color:black"></i></a>
          <a href="#"><i class="fa fa-snapchat" style="font-size:35px;padding:5px;color:yellow"></i></a>
