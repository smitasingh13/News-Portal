...
?>
        <div class="box">
        <p><center><b>Just In <?php echo date("F-jS-Y", strtotime($date));?></b></center></p>
            <img src="images/thumbnail/<?php echo $row['thumbnail']; ?>" alt=""><br><br>
            <h3><center> <a class="edit" style="color:#14213d;text-decoration:none;" href="single_page.php?single=<?php echo $row['id'];?>"><?php echo $title;?></center></h3></a>
            <span class="blog-text">
            <!--<?php echo substr($row['des'],0,100);?>-->
            </span>
        <div class="btns">
            <!--<a class="edit" href="single_page.php?single=<?php echo $row['id'];?>">Read More</a>-->
        </div>
...
?>
    <div class="card1">
        ...
        <div class="intro">
            <h3><a class="" style="text-decoration:none;" href="single_page.php?single=<?php echo $row['id'];?>"><?php echo $title;?></h3>
            <p>wkhjwjkehwjehqwkehwhe</p>
        </div>
        <?php }?>
    </div> 
<div class="break"></div>
