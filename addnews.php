...
<div style="margin-left: 20%; margin-top: 2%; width:70%; ">
  ...
  <form action="addnews.php" method="post" name="newsform" enctype="multipart/form-data" onsubmit="return validateForm();" >
    ...
    <div class="form-group">
      ...
      <textarea style="" class="form-control rounded-0" id="des" name="des" rows="8" cols="60" placeholder="Enter Description..."></textarea>
    </div>
    ...
    <button type="submit" name="add_news_btn" class="btn btn-primary">Add</button>
  </form>
